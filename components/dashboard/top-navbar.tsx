...
const pageMeta: Record<NavPage, { title: string; description: string }> = {
  Dashboard: { title: "Dashboard", description: "Visão consolidada do negócio" },
  Customers: { title: "Customers", description: "1.247 clientes cadastrados" },
  Deals: { title: "Deals", description: "24 negócios ativos · R$ 3,7M em aberto" },
  Pipeline: { title: "Pipeline", description: "9 negócios em andamento" },
  Tasks: { title: "Tasks", description: "8 tarefas pendentes" },
  Team: { title: "Team", description: "12 membros ativos" },
  Reports: { title: "Reports", description: "Desempenho consolidado · Maio 2026" },
  Settings: { title: "Settings", description: "Configurações da conta e workspace" },
}
  ...
  return (
    <header className="flex items-center h-[52px] px-5 border-b border-border bg-background shrink-0 gap-3">
      ...
      <div className="flex items-center gap-1.5 text-sm">
        <span className="text-muted-foreground text-[13px]">Pulse</span>
      ...
      <div className="relative">
        ...
        />
        <span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground font-mono pointer-events-none">⌘K</span>
      </div>
